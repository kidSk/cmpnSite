/**
 * @ngdoc controller
 * @name publicApp.admin.user.create.controller:UserCreateController
 * @description
...
(function () {
  ...
  angular
    .module('publicApp.admin.user.create')
    .controller('UserCreateController', UserCreateController);

  /**
   * @ngdoc function
   * @name publicApp.admin.user.create.provider:UserCreateController
   * @description
   * Provider of the {@link publicApp.admin.user.create.controller:UserCreateController UserCreateController}
   *
   ...
   * @returns {Service} {@link publicApp.admin.user.create.controller:UserCreateController UserCreateController}
   */
  ...
  function UserCreateController($mdDialog, Auth, User, Toast) {
     ...
     * @ngdoc property
     * @name userRoles
     * @propertyOf publicApp.admin.user.create.controller:UserCreateController
     * @description
     ...
     * @ngdoc function
     * @name create
     * @methodOf publicApp.admin.user.create.controller:UserCreateController
     * @description
