/**
 * @ngdoc overview
 * @name publicApp.admin.user.create
 * @description
 * The `publicApp.admin.user.create` module which provides
 *
 * - {@link publicApp.admin.user.create.controller:UserCreateController UserCreateController}
 *
 * @requires ui.router
 * @requires ngMaterial
 * @requires ngMessages
...
(function () {
  ...
  angular
    .module('publicApp.admin.user.create', [
      ...
      'publicApp.auth',
      'publicApp.toast',
      'publicApp.remoteUnique',
      'publicApp.mongooseError'
    ])
