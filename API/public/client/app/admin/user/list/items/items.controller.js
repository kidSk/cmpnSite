/**
 * @ngdoc controller
 * @name publicApp.admin.user.list.items.controller:UserItemsController
 * @description
...
(function () {
  ...
  /**
   * @ngdoc function
   * @name publicApp.admin.user.list.items.provider:UserItemsController
   * @description
   * Provider of the {@link publicApp.admin.user.list.items.controller:UserItemsController UserItemsController}
   *
   */
  ...
  function UserItemsController($state, Auth) {
     ...
     * @ngdoc function
     * @name isSelected
     * @methodOf publicApp.admin.user.list.items.controller:UserItemsController
     * @description
