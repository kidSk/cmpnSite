/**
 * @ngdoc overview
 * @name publicApp.admin.user.list.detail
 * @description
 * The `publicApp.admin.user.list.detail` module which provides:
 *
 * - {@link publicApp.admin.user.list.detail.controller:UserDetailController UserDetailController}
 *
 * @requires ui.router
 * @requires angularMoment
 * @requires publicApp.auth.user
 */
(function () {
  'use strict';
