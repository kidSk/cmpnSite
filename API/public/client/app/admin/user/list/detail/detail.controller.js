/**
 * @ngdoc controller
 * @name publicApp.admin.user.list.detail.controller:UserDetailController
 * @description
...
(function () {
   ...
   */
  angular
    .module('publicApp.admin.user.list.detail')
    .controller('UserDetailController', UserDetailController);

  /**
   * @ngdoc function
   * @name publicApp.admin.user.list.detail.provider:UserDetailController
   * @description
   * Provider of the {@link publicApp.admin.user.list.detail.controller:UserDetailController UserDetailController}
   *
   ...
   * @returns {Service} {@link publicApp.admin.user.list.detail.controller:UserDetailController UserDetailController}
   */
  ...
  function UserDetailController($state, user, Auth) {
     ...
     * @ngdoc property
     * @name user
     * @propertyOf publicApp.admin.user.list.detail.controller:UserDetailController
     * @description
     ...
     * @ngdoc function
     * @name edit
     * @methodOf publicApp.admin.user.list.detail.controller:UserDetailController
     * @description
