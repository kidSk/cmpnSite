/**
 * @ngdoc controller
 * @name publicApp.admin.user.list.edit.controller:EditPasswordController
 * @description
...
(function () {
  ...
  angular
    .module('publicApp.admin.user.list.edit')
    .controller('EditPasswordController', EditPasswordController);


  /**
   * @ngdoc function
   * @name publicApp.admin.user.list.edit.provider:EditPasswordController
   * @description
   * Provider of the {@link publicApp.admin.user.list.edit.controller:EditPasswordController EditPasswordController}
   *
   ...
   * @returns {Service} {@link publicApp.admin.user.list.edit.controller:EditPasswordController EditPasswordController}
   */
  ...
  function EditPasswordController($mdDialog, UserService, user, Toast) {
     ...
     * @ngdoc function
     * @name changePassword
     * @methodOf publicApp.admin.user.list.edit.controller:EditPasswordController
     * @description
