/**
 * @ngdoc controller
 * @name publicApp.admin.user.list.edit.controller:UserEditController
 * @description
...
(function () {
  ...
  /**
   * @ngdoc function
   * @name publicApp.admin.user.list.edit.provider:UserEditController
   * @description
   * Provider of the {@link publicApp.admin.user.list.edit.controller:UserEditController UserEditController}
