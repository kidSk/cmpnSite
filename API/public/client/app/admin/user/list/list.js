(function () {
  ...
  /**
   * Introduce the publicApp.admin.user.list module
   * and configure it.
   *
   * @requires ui.router
   * @requires ngMaterial
   * @requires {publicApp.socket}
   * @requires publicApp.mainMenu
   * @requires components/toggleComponent
   * @requires publicApp.admin.user.list.detail
   * @requires publicApp.admin.user.list.edit
   * @requires publicApp.admin.user.list.items
   */

  angular
    .module('publicApp.admin.user.list', [
      'ngMaterial',
      'ui.router',
      'publicApp.socket',
      'publicApp.mainMenu',
      'publicApp.toggleComponent',
      'publicApp.admin.user.list.detail',
      'publicApp.admin.user.list.edit',
      'publicApp.admin.user.list.items'
    ])
